...
temp = 7.2 # celsius ambient temperature outside || data: [7.2, 16.7] degrees C
Cd = 0.5
A = 0.013 ** 2 * pi
...
wind = Wind(avg_direction=array([0.75, 0.25, 0.0]), uncert_direction=0.1, avg_speed=1.3, uncert_speed=0.13, frequency=0.2, uncert_frequency=0.05, decay_rate=1)
